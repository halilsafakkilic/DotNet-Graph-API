...
namespace netCoreGraphQL.Repositories
{
    public class DataGenerator
    {
        ...
        public IList<Brand> GenerateBrand(int limit)
        {
            ...
            {
                Brands.Add(new Brand(Guid.NewGuid(), _faker.Name.LastName()));
            }
        ...
        public IList<Product> GenerateProduct(int limit, IList<Brand> Brands)
        {
            ...
            for (int i = 0; i < limit; i++)
            {
                Products.Add(new Product(Guid.NewGuid(), _faker.PickRandom(Brands), _faker.Commerce.ProductName(), _faker.Random.Double(10, 100)));
            }
